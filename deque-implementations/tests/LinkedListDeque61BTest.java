...
public class LinkedListDeque61BTest {
    ...
    public void testIsEmpty() {
        ...
        assertThat(lld1.toList()).isNotEmpty();
    ...
    public void testGet() {
         ...
         assertThat(lld1.get(0)).isEqualTo(420);
         assertThat(lld1.get(1)).isEqualTo(67);
         assertThat(lld1.get(2)).isEqualTo(69);
    ...
    public void testGetRecursive() {
        ...
        assertThat(lld1.getRecursive(0)).isEqualTo(420);
        assertThat(lld1.getRecursive(1)).isEqualTo(67);
        assertThat(lld1.getRecursive(2)).isEqualTo(69);
    ...
    public void testRemoveFirst() {
        ...
        lld1.addLast(4);
        assertThat(lld1.toList()).containsExactly(2, 1, 4).inOrder();

        assertThat(lld1.removeFirst()).isEqualTo(2);
        assertThat(lld1.toList()).containsExactly(1, 4).inOrder();
        ...
        assertThat(lld1.removeFirst()).isEqualTo(67);
        assertThat(lld1.toList()).isEmpty();
        lld1.addLast(69);
        assertThat(lld1.toList()).containsExactly(69).inOrder();
